...
export class CreateReportsAndReportLeavesTables1761226000355 implements MigrationInterface {
    name = 'CreateReportsAndReportLeavesTables1761226000355'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "reports" ("id" SERIAL NOT NULL, "cid" text NOT NULL, "refSlot" integer NOT NULL, "blockNumber" integer NOT NULL, "timestamp" integer NOT NULL, "prev_tree_cid" text, "tree" jsonb NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_d2d99f0fc881c10c1b7c6f811f1" UNIQUE ("cid"), CONSTRAINT "PK_d9013193989303580053c0b5ef6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_d2d99f0fc881c10c1b7c6f811f" ON "reports" ("cid") `);
        await queryRunner.query(`CREATE TABLE "report_leaves" ("id" SERIAL NOT NULL, "vault_address" character varying(42) NOT NULL, "total_value_wei" numeric(78,0) NOT NULL, "in_out_delta" numeric(78,0) NOT NULL, "prev_fee" numeric(78,0) NOT NULL, "infra_fee" numeric(78,0) NOT NULL, "liquidity_fee" numeric(78,0) NOT NULL, "reservation_fee" numeric(78,0) NOT NULL, "fee" numeric(78,0) NOT NULL, "liability_shares" numeric(78,0) NOT NULL, "max_liability_shares" numeric(78,0) NOT NULL, "slashing_reserve" numeric(78,0) NOT NULL, "tree_index" integer NOT NULL, "reportId" integer, CONSTRAINT "PK_3f812363c757395105b50b18e13" PRIMARY KEY ("id"))`);
