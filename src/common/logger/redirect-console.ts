...
// Third-party code logs straight to `console` — e.g. @lidofinance/lsv-cli prints
// `Error fetching beacon header. Used URL: <clUrl>` on any CL failure, and that url carries
// the api key. Such output skips the central logger entirely: it is neither JSON nor
// secret-masked. Routing console.* through the logger puts it back under masking.
//
