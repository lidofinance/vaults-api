export const VaultHubAbi = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct VaultHub.VaultInfo[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  },
  {
    ...
    name: 'isVaultHealthyAsOfLatestReport',
    outputs: [
      {
        internalType: 'bool',
        name: '',
